...
class EventRepository {
  ...
  static final List<EventItem> _fallbackEvents = [
    const EventItem(
      ...
      description:
          'Connect with top hiring partners in logistics, warehousing, and delivery services across Mumbai, Delhi, and Bangalore.',
      date: '2026-09-28',
      time: '10:00 AM IST',
    ...
    const EventItem(
      ...
      description:
          'Interactive coaching session on optimizing your candidate CV and negotiating high-bracket wages with verified recruiters.',
      date: '2026-10-02',
      time: '6:30 PM IST',
    ...
    const EventItem(
      ...
      description:
          'Learn about route optimization, insurance benefits, and maximizing peak-hour gig dispatches on KaamMilega.',
      date: '2026-10-10',
      time: '4:00 PM IST',
