  ...
  final List<Map<String, dynamic>> _modules = [
    {
      ...
      'bgGradient': [AppColors.brandNavy, AppColors.blue],
      'badge': 'Primary Hub',
      'route': '/jobs',
    },
    {
      ...
      'bgGradient': [AppColors.accent, AppColors.accentBright],
      'badge': 'InstantMilega™',
      'route': '/instant-work',
    },
    {
      ...
      'bgGradient': [AppColors.moduleSkills, AppColors.brandNavy],
      'badge': 'Marketplace',
    ...
    },
    {
      ...
      'bgGradient': [AppColors.moduleExperts, AppColors.brandNavy],
    ...
    },
    {
      ...
      'bgGradient': [AppColors.moduleServices, AppColors.brandNavy],
      'badge': 'Services',
      'route': '/services',
    },
    {
      ...
      'bgGradient': [AppColors.moduleP2P, AppColors.brandNavy],
      'badge': 'Networking',
      'route': '/peer-to-peer',
    },
    {
      ...
      'bgGradient': [AppColors.accent, AppColors.moduleEvents],
      'badge': 'Community',
      'route': '/events',
    },
  ];
