...
- **UI:** keep brand colours (`AppColors`, e.g. `#1A2B8C`, `#F97316`, `#9333EA`); do not cap text scaling — make layouts flexible; handle small screens, keyboard, long text, loading/empty/error states; mobile bottom sheets over desktop-style dropdowns.
